...
import { originalConsoleDebug, originalConsoleError, originalConsoleInfo, originalConsoleLog, originalConsoleWarn, originalStderrWrite, originalStdoutWrite, } from './overrides';
...
export function setPrevious(str) {
    previous = str;
}
 ...
 */
export function onlyWhitespace(raw) {
    const visible = raw
...
export function squashNewlines(str) {
 ...
 */
function createSquashingWriteFunction(originalWrite, isSquashingEnabled) {
    return function (chunk, encodingOrCallback, callbackMaybe) {
...
process.stdout.write = createSquashingWriteFunction(originalStdoutWrite, () => squashingEnabled);
process.stderr.write = createSquashingWriteFunction(originalStderrWrite, () => squashingEnabled);
