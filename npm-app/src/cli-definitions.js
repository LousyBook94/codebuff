...
export const cliOptions = [
    ...
    },
    {
        ...
        description: 'Specify which agent to invoke (e.g., "file-picker", "reviewer", "base")',
    ...
    {
        flags: '--print, -p',
        description: 'Print-only mode: run until first response completes then exit (requires prompt or params)',
