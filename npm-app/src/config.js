...
export const websocketUrl = process.env.NEXT_PUBLIC_CODEBUFF_BACKEND_URL?.includes('localhost')
...
export const backendUrl = process.env.NEXT_PUBLIC_CODEBUFF_BACKEND_URL?.includes('localhost')
