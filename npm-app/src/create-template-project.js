...
export async function createTemplateProject(template, projectDir, projectName = template) {
    ...
    try {
        ...
        execSync('git clone --depth 1 https://github.com/CodebuffAI/codebuff-community.git .', {
            cwd: tempDir,
            stdio: 'pipe',
        });
