...
const AGENT_CREATION_STEPS = [
    ...
    {
        question: 'Which model should this agent use? (Press Enter for default: anthropic/claude-4-sonnet-20250522)',
        field: 'model',
...
export function startAgentCreationChat(rl, onExit, onComplete) {
...
export async function createAgentFromRequirements(requirements) {
...
Please create a complete TypeScript agent template file in the ${AGENT_TEMPLATES_DIR} directory with proper types and a comprehensive system prompt.`;
    try {
        ...
        await cliInstance.resetAgent(AgentTemplateTypes.agent_builder, {
        ...
        console.log(gray('Continue adjusting your agent here, or type "/agents" to switch agents and test it out.'));
