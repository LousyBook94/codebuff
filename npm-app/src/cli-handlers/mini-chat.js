...
function processUserInput(input) {
    ...
    if (chatConfig && currentStep < chatConfig.steps.length) {
        ...
        isProcessing = true;
        addMessage('assistant', 'Perfect! I have everything I need. Processing your responses...');
...
function setupKeyHandler(rl, onExit) {
...
export function enterMiniChat(rl, onExit, config) {
    if (isInMiniChat) {
...
export function isInMiniChatMode() {
    return isInMiniChat;
}
// Cleanup function
