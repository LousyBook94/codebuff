...
import { backgroundProcesses, spawnAndTrack, } from '../background-process-manager';
export function runBackgroundCommand(options, resolveCommand) {
    ...
    try {
        ...
        assert(childProcess.pid !== undefined, 'Failed to spawn process: no PID assigned.');
